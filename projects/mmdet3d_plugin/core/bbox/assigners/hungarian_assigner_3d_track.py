    ...
    def assign(self,
        ...
        Args:
            bbox_pred (Tensor): Predicted boxes with normalized coordinates
                (cx, cy, w, l, cz, h, rot_sine, rot_cosine, vx, vy), which are all in range [0, 1]. Shape
                [num_query, code_size].
            cls_pred (Tensor): Predicted classification logits, shape
                [num_query, num_class].
            gt_bboxes (Tensor): Ground truth boxes with unnormalized
                coordinates. Shape [num_gt, code_size].
        ...
        Returns:
            :obj:`tuple`: (matched_row_inds, matched_col_inds)
        """
